...
ttk.Radiobutton(frame_right, text="75% / 25%", variable=selected_option, value="1").pack(anchor="w", padx=5, pady=2)
ttk.Radiobutton(frame_right, text="50% / 50%", variable=selected_option, value="2").pack(anchor="w", padx=5, pady=2)
